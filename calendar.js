import { Component, EventEmitter, Input, Output, TemplateRef, Inject, LOCALE_ID, ChangeDetectionStrategy } from '@angular/core';
...
var CalendarComponent = (function () {
    ...
    CalendarComponent.prototype.showEventCircle = function (event, monthRow) {
        if (monthRow.events) {
            var index = _.findIndex(monthRow.events, function (actEvent) {
